        ...
        <div class="px-2 sp:px-4 sp:my-[100px] my-[50px]">
            <div class="flex flex-col items-center mt-6">
                ...
                <div v-if="!$utils.isMockup()" class="flex justify-center items-center border border-black rounded-full overflow-hidden"
                    ...
                    <img :src="$formatImage({url: guestData.avatar, type: guestData.avatar_type})" 
                ...
                <div v-if="$utils.isMockup()" class="flex justify-center items-center border border-black rounded-full overflow-hidden"
                    style="width: 40px; height: 40px;">
                    <img :src="$formatImage({url: '', type: ''})" class="object-cover w-full h-full" :class="{'w-6 h-6' : false}" alt="User Avatar">
                </div>
...
onMounted(async() => {
    startLoading(SECTIONS.PROFILE.GLOBAL);
    ...
    stopLoading(SECTIONS.PROFILE.GLOBAL);
...
// Configuración de las tabs para SlideTransition
const tabs = [
    { name: 'Profile', routeName: 'Profile' },
    { name: 'PersonalInfo', routeName: 'PersonalInfo' },
    { name: 'MyStays', routeName: 'MyStays' },
    { name: 'Inbox', routeName: 'Inbox' },
    { name: 'SelectLanguage', routeName: 'SelectLanguage' },
    { name: 'ReservationStay', routeName: 'ReservationStay' }
];
</script>
