<template>
    <div class="relative w-full">
        ...
        <input
            ...
            class="rounded-[100px] h-[20px] sp:h-[40px] w-full pl-5 sp:pl-11 lato py-1.5 sp:py-3 text-[8px] sp:text-sm font-medium leading-[16px] border-[2px] focus:border-[#333] border-[#bfbfbf]"
