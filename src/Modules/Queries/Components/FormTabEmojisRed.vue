<template>
    <div 
        class="flex justify-between md:mx-[-16px] px-1 sp:px-2 md:px-0"
        id="emoji-tab-form"
    >
      <div class="text-center md:px-4">
        <div 
          class="flex w-[32px] h-[32px] mx-auto sp:w-[40px] sp:h-[40px] md:w-[64px] md:h-[64px]"
          id="emoji-VERYWRONG-button"
          @click="selectEmoji('VERYWRONG')"
        >
          <img
            class="mx-auto mt-auto cursor-pointer"
            :class="form.type && form.type !== 'VERYWRONG' ? 'sp:w-[32px] sp:h-[32px] md:w-[52px] md:h-[52px]' : 'w-full h-full'"
            :src="`/assets/icons/emojis/colors/1.TH.EMOJI.${state_emojis?.VERYWRONG?.face}.${state_emojis?.VERYWRONG?.mode}.svg`"
      ...
      <div class="text-center md:px-4">
        ...
        >
          <img
            class="mx-auto mt-auto cursor-pointer"
            :class="form.type && form.type !== 'WRONG' ? 'sp:w-[32px] sp:h-[32px] md:w-[52px] md:h-[52px]' : 'w-full h-full'"
      ...
      <div class="text-center md:px-4">
        ...
        >
          <img
            class="mx-auto mt-auto cursor-pointer"
            :class="form.type && form.type !== 'NORMAL' ? 'sp:w-[32px] sp:h-[32px] md:w-[52px] md:h-[52px]' : 'w-full h-full'"
      ...
      <div class="text-center md:px-4">
        ...
        >
          <img
            class="mx-auto mt-auto cursor-pointer"
            :class="form.type && form.type !== 'GOOD' ? 'sp:w-[32px] sp:h-[32px] md:w-[52px] md:h-[52px]' : 'w-full h-full'"
      ...
      <div class="text-center md:px-4">
        ...
        >
          <img
            class="mx-auto mt-auto cursor-pointer"
            :class="form.type && form.type !== 'VERYGOOD' ? 'sp:w-[32px] sp:h-[32px] md:w-[52px] md:h-[52px]' : 'w-full h-full'"
            :src="`/assets/icons/emojis/colors/1.TH.EMOJI.${state_emojis?.VERYGOOD?.face}.${state_emojis?.VERYGOOD?.mode}.svg`"
