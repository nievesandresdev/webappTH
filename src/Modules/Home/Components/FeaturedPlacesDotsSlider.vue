                ...
                <div class="relative w-full h-full">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 py-2 px-2 text-white" style="background-color: rgba(51, 51, 51, 0.5);">
                        <div class="flex justify-between items-end">
                            <!-- titulo y distancia-->
                            <div class="flex-1">
                                <h3 class="text-[#FAFAFA] font-bold sp:text-[16px] text-[12px] lato line-clamp-2 mb-1" v-html="place.title"></h3>
                                <div class="flex items-center gap-[2px]">
                                    <img src="/assets/icons/WA.pointer.svg" class="w-3 h-3 filter brightness-0 invert" alt="pointer">
                                    <p class="text-[#FAFAFA] sp:text-[12px] text-[10px] lato font-medium">{{ place.distance }}km</p>
