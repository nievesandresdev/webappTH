...
<style lang="scss">
    #carousel-facility-0, #carousel-facility-1, #carousel-facility-2, #carousel-facility-3 {
    ...
    #carousel-facility-0:hover, #carousel-facility-1:hover, 
    #carousel-facility-2:hover, #carousel-facility-3:hover {
        .carousel__prev, .carousel__next {
            display: block;
        }
    }
